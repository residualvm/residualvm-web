...
function screenshot_previewer_link ($id, $content) {
	...
	$result =
	"<a href=\"javascript:window.open('screenshots.php?screenshotID='+" . $id . ",'residual_screenshot_viewer','menubar=no,scrollbars=no,status=no,width=640,height=483').focus()\"" .
